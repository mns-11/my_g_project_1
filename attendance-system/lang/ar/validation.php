...
return [
    ...
    */
    ...
    'ascii' => 'حقل :attribute يجب أن يحتوي فقط على رموز وحروف أحادية البايت.',
    ...
    'extensions' => 'حقل :attribute يجب أن يكون ملفاً بأحد الامتدادات التالية: :values.',
    ...
    'hex_color' => 'حقل :attribute يجب أن يكون رمز لون سداسي عشري صحيح.',
    ...
    'min' => [
        ...
        'string' => 'يجب أن يحتوي حقل :attribute على :min حروف على الأقل.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'تم العثور على حقل :attribute في تسريب بيانات. يرجى اختيار حقل مختلف.',
    ],
    ...
    'required_array_keys' => 'يجب أن يحتوي حقل :attribute على المدخلات: :values.',
