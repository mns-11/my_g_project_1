...
@section('title', ucwords(__('main.edit_hall')))
...
@section('content')
    ...
    <div class="content p-4">
        <div class="card card-body">
            <div class="container">
                <h2 class="mt-4">{{ucwords(__('main.edit_hall'))}}</h2>
                <form action="{{ route('halls.update', $hall->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $hall->name) }}" />
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location', $hall->location) }}" />
