...
@section('title', ucwords(__('main.edit_college')))
...
@section('content')
    ...
    <div class="content p-4">
        <div class="card card-body">
            <div class="container">
                <h2 class="mt-4">{{ucwords(__('main.edit_college'))}}</h2>
                <form action="{{ route('colleges.update', $college->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location', $college->location) }}" />
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $college->phone) }}" />
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $college->email) }}" />
