...
@section('title',ucwords(__('main.add_coordinator')))
...
@section('content')
    ...
    <div class="content p-4">
        <div class="card card-body">
            <div class="container">
                <h2 class="mt-4">{{ucwords(__('main.add_coordinator'))}}</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <select name="gender" class="form-control @error('gender') is-invalid @enderror" id="Gender">
                                ...
                                <option
                                    value="{{ App\Enums\UserGender::Male }}" {{old('gender') === App\Enums\UserGender::Male->value ? 'selected' : '' }}> {{ App\Enums\UserGender::Male->value}} </option>
                                <option
                                    value="{{ App\Enums\UserGender::Female }}" {{old('gender') === App\Enums\UserGender::Female->value ? 'selected' : '' }}> {{ App\Enums\UserGender::Female->value }} </option>
                            </select>
                            @error('gender')
                            <span class="validation-text text-danger">{{ $message }}</span>
                            @enderror
