...
@section('title', ucwords(__('main.edit_major')))
...
@section('content')
    ...
    <div class="content p-4">
        <div class="card card-body">
            <div class="container">
                <h2 class="mt-4">{{ucwords(__('main.edit_major'))}}</h2>
                <form action="{{ route('majors.update', $major->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select @error('college_id') is-invalid @enderror"
                                ...
                                @foreach($colleges as $college)
                                    <option
                                        value="{{ $college->id }}" {{ (old('college_id', $major->college_id) == $college->id) ? 'selected' : '' }}>{{ $college->name }}</option>
                                @endforeach
                            </select>
                            @error('college_id')
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" name="num_levels" id="levels" class="form-control @error('num_levels') is-invalid @enderror" value="{{ old('num_levels', $major->num_levels) }}" />
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location', $major->location) }}" />
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $major->phone) }}" />
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $major->email) }}" />
