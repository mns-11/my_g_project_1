...
@section('content')
    ...
    <div class="content p-4">
        <div class="header-container">
            <h2>{{ ucwords(__('main.doctor_management'))}}</h2>
            <div class="d-flex flex-wrap gap-2">
                <form class="position-relative" method="GET" action="{{route('teachers.index') }}" id="search-form">
        ...
        <div class="table-container">
            ...
            @foreach($users as $user)
                <tr>
                    ...
                    <td>{{$user->phone}}</td>
                    <td>
                        <a href="{{route('teachers.edit', $user->id)}}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                        @if(auth()->id() != $user->id)
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">{{ucwords(__('main.confirm_doctor_deletion'))}}</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="text-center mb-4">
                                                <i class="fas fa-exclamation-triangle fa-3x text-danger mb-3"></i>
                                                <h4>{{ucwords(__('main.are_you_sure_you_want_to_delete_doctor_data'))}}</h4>
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="POST" action="{{route('teachers.destroy', $user->id)}}">
                                                @csrf
                                                @method('DELETE')
