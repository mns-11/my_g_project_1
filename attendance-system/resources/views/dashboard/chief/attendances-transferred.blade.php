...
@section('title',ucwords(__('main.major_chief_excuses')))
...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row mt-5 animate__animated animate__fadeIn">
            <div class="col-12">
                <div class="card p-4">
                    <h3 class="text-center mb-4"><strong>{{ucwords(__('main.review_forwarded_excuses'))}}</strong></h3>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($attendances as $attendance)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('chief.attendances.excuses.update', $attendance->id) }}" method="post" class="excuse-form">
                                            @csrf
                                            @method('PUT')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ucwords(__('main.reject_excuse'))}}</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="confirmReject">{{ucwords(__('main.reject_excuse'))}}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.querySelectorAll('.transform-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                form.querySelector('[name="is_approved"]').value = '1';
                form.submit();
            });
        });
        ...
        document.getElementById('confirmReject').addEventListener('click', function() {
            ...
            form.querySelector('[name="is_approved"]').value = '0';
