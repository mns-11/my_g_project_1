...
@section('title',ucwords(__('main.doctor_management')))
...
">
                    ...
                    <div class="header-container">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <form class="position-relative" method="GET" action="{{route('chief.teachers.index') }}" id="search-form">
                            ...
                            <a href="{{route('chief.teachers.create')}}" class="btn btn-primary" >
                                <i class="fas fa-plus me-1"></i>{{ucwords(__('main.add_doctor'))}}
                            </a>
                        </div>
                    </div>
                    ...
                    <h3 class="text-center mb-4"><strong>{{ucwords(__('main.doctor_management'))}}</strong></h3>
                    <br>
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th style="background-color: #228B22; color: white;">{{ucwords(__('main.name'))}}</th>
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>{{$user->phone}}</td>
                                    <td>
                                        <a href="{{route('chief.teachers.edit', $user->id)}}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form method="POST" action="{{route('chief.teachers.destroy', $user->id)}}">
                                                                @csrf
                                                                @method('DELETE')
